    ...
    <div id="bgSignUp" className=" flex justify-between w-full h-[100vh]">
      ...
      <div className=" bgForm2">
        <div className="flexStuff">
          ...
          <h2 className="pb-2 pt-1  mx-28   text-2xl">
        ...
        <form className="" action="/overview">
          ...
          <input
            className="login3 border-2   mx-20 px-5 py-2 mb-[10px] mt-[5px] w-[400px] "
            name="fname"
          ...
          <br />
          <input
            className="login3 px-5 h-14 py-[5px] mb-[10px]  mx-20 mt-[5px] border-2 w-[400px] "
            name="fname"
            placeholder="Enter Last Name"
          />
          <label  className=" login4  py-2 ">Phone</label> <br />
          <input
            className=" login3 border-2 h-14 mx-20 px-5 py-2 mb-[10px] mt-[5px] w-[400px] "
            name="fname"
          ...
          <br />
          <input
            className=" login5 px-5 h-14 py-[5px] mx-20 mb-[10px]  mt-[5px] border-2 w-[400px]"
            name="fname"
          ...
          <div className=" flex justify-center content-center  ">
            <input
              type="submit"
              className=" login3 bg-[#B3C10F] h-14  text-xl    text-white text-1.5xl mt-[30px] mb-[10px]  w-[400px] "
              value="Sign Up"
            />
          </div>
