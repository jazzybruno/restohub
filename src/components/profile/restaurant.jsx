    ...
    return(
        <div className='mainProfile h-[100%]'>
            ...
            <div className="profilerun flex ">
                ...
                <div onClick={()=> setStep(1)} style={{backgroundColor:step===1 ? "#b3c10f": "white" }}
                   ...
                   <div
                   onClick={()=> setStep(2)} style={{backgroundColor:step===2 ? "#b3c10f": "white" }}
                    className="options flex ml-10 mt-10 cursor-pointer ">
                   ...
                   <div 
                   onClick={()=> setStep(3)} style={{backgroundColor:step===3 ? "#b3c10f": "white" }}
                   className="options flex ml-10 mt-10 cursor-pointer">
